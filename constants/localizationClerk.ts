...
export const ruRU: LocalizationResource = {
  ...
  organizationProfile: {
    ...
    profilePage: {
      ...
      dangerSection: {
        ...
        deleteOrganization: {
          ...
          messageLine2: "Это действие нельзя отменить.",
          actionDescription:
            "Напишите {{organizationName}} в поле ниже, чтобы продолжить.",
    ...
    verifyDomainPage: {
      ...
      subtitle:
        "Домен {{domainName}} должен быть верифицирован через электронную почту.",
      ...
      formSubtitle:
        "Введите код подтверждения, отправленный на указанную почту",
    ...
    verifiedDomainPage: {
      ...
      enrollmentTab: {
        ...
        calloutInfoLabel:
          "Изменение способа присоединения повлияет только на новых пользователей.",
      ...
      dangerTab: {
        ...
        calloutInfoLabel:
          "Удаление домена повлияет на приглашенных пользователей.",
      },
    },
    invitePage: {
